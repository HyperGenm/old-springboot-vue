...
<script>
    ...
    export default {
        ...
        data() {
            return {
                ...
                icons: [
                    ...
                    {
                        "src": "http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/3b/shiziwang_xinba_org.png",
                        "alt": "[辛巴]"
                    },
                    {
                        "src": "http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/43/shiziwang_xiaoxinba_org.png",
                        "alt": "[小辛巴]"
                    },
                    {
                    ...
                    {
                        "src": "http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/db/angerbird_zhandanhei_org.png",
                        "alt": "[炸弹黑hi]"
                    },
                    {
        ...
        mounted() {
            let that = this;
            let {icons, html, menus, zIndex, pasteFilterStyle, pasteIgnoreImg, colors, emotions, fontNames, uploadImgShowBase64} = this;
            ...
            if (null != emotions && 0 < emotions.length) {
                _emotions = _emotions.concat(emotions);
            }
            // 表情面板可以有多个 tab ，因此要配置成一个数组。数组每个元素代表一个 tab 的配置
            editor.customConfig.emotions = _emotions;
            // 自定义字体
